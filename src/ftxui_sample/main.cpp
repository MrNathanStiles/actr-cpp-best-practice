...
// configuration step. It creates a namespace called `actr_cpp_best_practice`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", actr_cpp_best_practice::cmake::project_name, actr_cpp_best_practice::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", actr_cpp_best_practice::cmake::project_version);
      return EXIT_SUCCESS;
    }
